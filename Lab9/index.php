...
$pokemon2 = new Electric('Electrabuzz','Electric',40,4,'electrabuzz.png');
$pokemon3 = new Water('Gyardos','Water',44,6,'gyardos.png');
$pokemon4 = new Psychic('Abra','Psychic',106,4,'abra.png');
